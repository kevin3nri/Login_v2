...
<body>  
    ...
    <nav class="navbar navbar-expand-lg" aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">ASISTENCIAS</a></li>
            </ol>
          </nav>
    </div>
        <!-- End Page Title -->
                            ...
                            <table id="example" class="table table-success border-dark table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="php/docente/listalumasis.php?idActividad=<?php echo $row['idActividad']; ?>" class="btn btn-danger">
