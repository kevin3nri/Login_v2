			...
			<div class="wrap">
				<form action="php/editar.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "NAMES">
						<input class="input100" type="text" name="admNames" value="<?php echo $row['admNames']; ?>">
						<span class="focus-input100" data-placeholder="Nombre"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "GENERO">Genero
                        <select class="form-select" aria-label="Default select example" name="admSex" value="<?php echo $row['admSex']; ?>">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input class="input100" type="password" name="admClue" value="<?php echo $row['admClue']; ?>">
						<span class="focus-input100" data-placeholder="Password"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "STATE">ESTADO
                        <select class="form-select" aria-label="Default select example" name="admState" value="<?php echo $row['admState']; ?>">
