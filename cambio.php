		...
		<div class="container">
			<div class="wrap">
                <?php  
                    ...
                    if (isset($_SESSION['matristu'])) {
                        $matristu = $_SESSION['matristu'];
                    
                        $stmt = $conexion->prepare("SELECT * FROM students WHERE matristu = ?");
                        $stmt->bind_param("s", $matristu);
                        $stmt->execute();
                ...
                ?>
				<form action="php/alumno/cambiocon.php" method="POST">
					<span class="login100-form-title p-b-26">
						Editar Contraseña
                    </span>

                    <div class="validate-input" data-validate="Matrícula">
                        <input class="input100" type="hidden" name="matricula" value="<?php echo $row['matristu']; ?>">
                    </div>
